...
45 scanners em paralelo · 542 assinaturas de detecção · execução local, sem envio de dados
...
| Anti-forense | Detecção de formatação recente e de fontes históricas zeradas em conjunto; limpeza do log de Security; USN Journal (exec criado/apagado no disco — sobrevive ao arquivo ser apagado) |
