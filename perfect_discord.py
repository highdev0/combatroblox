...
# Fix indentation of the block under `for match in URL_RE.findall(blob):`
...
for line in lines:
    ...
    if in_for:
        if line == '':
            ...
            # line was indented at 16 spaces (e.g., "                try:")
            # It needs to be indented at 28 spaces (+12 spaces)
            # `for match` is at 24 spaces. So its body is at 28 spaces.
            # 16 + 12 = 28 spaces.
            # We just add 12 spaces to every non-empty line
            out_lines.append('            ' + line)
    else:
        out_lines.append(line)
